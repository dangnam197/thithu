...
//
    ...
    private void setMediaData(int progress){
       ...
       mediaPlayer = MediaPlayer.create(getApplicationContext(), Uri.parse(getApplicationContext().getString(R.string.rootLink)+"file/audio/"));

    }
    private void setMediaData(String url){
        if (mediaPlayer!=null) {
            mediaPlayer.stop();
        }
